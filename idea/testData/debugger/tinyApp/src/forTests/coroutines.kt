...
fun <T> Continuation<T>.resume(result: T) = resumeWith(SuccessOrFailure.success(result))
fun Continuation<*>.resumeWithException(exception: Throwable) = resumeWith(SuccessOrFailure.failure(exception))
